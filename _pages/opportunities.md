...
1. Strongly interested in interdisciplinary research in energy and climate policy;

2. Committed to contributing to an inclusive, respectful, and productive research environment;

3. Holders of a bachelor’s or master’s degree in a broadly relevant field (e.g., environmental studies, public policy, economics, business, electrical or industrial engineering, computer science, or mathematics);

4. Experienced in relevant research (a plus) and proficient in programming/data analysis (preferred);
...
1. Ph.D. from a leading university (awarded or expected soon) in a relevant field.

2. Strong quantitative skills in modeling and data analysis; proficiency in at least one programming language (R, Python, or MATLAB).
